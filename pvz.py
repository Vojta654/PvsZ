...
def draw_board():
    ...
    for j in range(BOARD_SIZE_Y):
        ...
        for index in range(0, BOARD_SIZE_X, 2):
            pygame.draw.rect(window, SQUARE02_COLOR, ((index + odd) * SQUARE_SIZE_X, (j * SQUARE_SIZE_Y) + MENU_SIZE, SQUARE_SIZE_X, SQUARE_SIZE_Y))
...
for index in range(5):
    bullets.append((1.5 * SQUARE_SIZE_X, (index+0.5)*SQUARE_SIZE_Y + MENU_SIZE - BULLET_SIZE/2))
